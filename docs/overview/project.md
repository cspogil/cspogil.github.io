...
!!! note
    ...
    The original CS-POGIL website is still available at [old.cspogil.org](https://old.cspogil.org/Home).

    The IntroCS-POGIL Project also has a website at [introcspogil.org](https://introcspogil.org/).
